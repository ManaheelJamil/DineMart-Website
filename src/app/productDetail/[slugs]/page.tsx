...
const detail = async (param: any) => {
  const userId = `${param}`;
  console.log("this is the user id you want to fetch response---->>>",userId);
  const response = await client.fetch(`*[_type == "product" && _id == "${userId}"]
          ...
          <div>
            <div className=' tablet:flex small:flex gap-5 tablet:justify-center mobile:ml-10 table:ml-0 py-20 '>
              ...
              <div>
                ...
                <p className='text-gray-400 text-xl capitalize '>{item.subCategory}</p>
