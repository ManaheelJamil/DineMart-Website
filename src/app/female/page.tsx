    ...
    return (
        <div className="grid justify-center gap-10 mt-10">
            <div>
                ...
                <div className='grid mobile:grid-cols-1 small:grid-cols-2  tablet:grid-cols-3 gap-20  max-w-[1000px] mx-auto mt-10 '>
                    {
                        products.map((product: any, id: any) => {
                            return <div className='mt-5 mobile:mx-5 tablet:ml-0' key={id}>
                                <Link href={`./productDetail/${product._id}`}>
                                <Image src={product.image} alt='logo' className='h-auto hover:scale-110 duration-700 bg-cover' width={500} height={400} />
