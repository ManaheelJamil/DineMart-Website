...
const Product = () => {
  ...
  return (
    <div>
      <h1 className='text-4xl mt-44 tablet:w-[1100px] mx-auto text-black font-bold'>Shopping Cart</h1>
      {
        (data) ? (
                    ...
                    <div className=' flex hover:shadow-lg tablet:w-[800px]  mobile:w-[600px] gap-5 mt-5 '>
                      ...
                      <button> <RiDeleteBin6Line className="text-2xl ml-72 " onClick={() => deleteCartItem(value.id)} />
                        <div className='flex space-x-4 ml-44 mt-32'>
                          ...
                          > - </button>
                          <input type="number" className="text-xl w-10  mt-2" onChange={onInputChange} value={value.quantity} />
